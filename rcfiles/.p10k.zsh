# Generated by Powerlevel10k configuration wizard on 2024-02-04 at 20:35 PST.
...
() {
  ...
  # Gigi: commented out to always show k8s context
  ...
  # Gigi: replaced kube-context to always show the context name
  ...
  # Gigi: commented out to always show AWS profile
